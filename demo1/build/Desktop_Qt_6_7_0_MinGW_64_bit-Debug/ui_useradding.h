/********************************************************************************
** Form generated from reading UI file 'useradding.ui'
**
...
#ifndef UI_USERADDING_H
#define UI_USERADDING_H
...
public:
    ...
    void setupUi(QDialog *USERADDING)
    {
        if (USERADDING->objectName().isEmpty())
            USERADDING->setObjectName("USERADDING");
        USERADDING->resize(1600, 780);
        USERADDING->setStyleSheet(QString::fromUtf8("background-color: rgb(31, 31, 31);"));
        label_11 = new QLabel(USERADDING);
        label_11->setObjectName("label_11");
        label_11->setGeometry(QRect(70, 40, 211, 51));
...
""));
        ...
        frame = new QFrame(USERADDING);
        frame->setObjectName("frame");
        frame->setGeometry(QRect(110, 190, 511, 501));
...
"}"));
        ...
        frame_2 = new QFrame(USERADDING);
        frame_2->setObjectName("frame_2");
        frame_2->setGeometry(QRect(870, 190, 511, 321));
...
""));
        ...
        dateEdit->setMinimumDateTime(QDateTime(QDate(1899, 12, 29), QTime(0, 0, 0)));
        label_PinError = new QLabel(frame_2);
        label_PinError->setObjectName("label_PinError");
        label_PinError->setGeometry(QRect(230, -10, 301, 31));
        label_PinError->setStyleSheet(QString::fromUtf8("color: rgb(255, 0, 0);"));
        frame_3 = new QFrame(USERADDING);
        frame_3->setObjectName("frame_3");
        frame_3->setGeometry(QRect(900, 550, 481, 141));
...
"border-radius:20px;\n"
"}"));
        label_9 = new QLabel(USERADDING);
        label_9->setObjectName("label_9");
        label_9->setGeometry(QRect(580, 110, 281, 51));
        QFont font8;
        ...
        retranslateUi(USERADDING);

        QMetaObject::connectSlotsByName(USERADDING);
    } // setupUi

    void retranslateUi(QDialog *USERADDING)
    {
        USERADDING->setWindowTitle(QCoreApplication::translate("USERADDING", "Dialog", nullptr));
        label_11->setText(QString());
        label->setText(QCoreApplication::translate("USERADDING", "UserName", nullptr));
        label_2->setText(QCoreApplication::translate("USERADDING", "E-mail", nullptr));
        label_3->setText(QCoreApplication::translate("USERADDING", "Phone_Number", nullptr));
        label_4->setText(QCoreApplication::translate("USERADDING", "password", nullptr));
        label_5->setText(QCoreApplication::translate("USERADDING", "confirm_password", nullptr));
        ...
        label_6->setText(QCoreApplication::translate("USERADDING", "pin", nullptr));
        label_7->setText(QCoreApplication::translate("USERADDING", "confirm_pin", nullptr));
        label_8->setText(QCoreApplication::translate("USERADDING", "Birth Date", nullptr));
        label_ConfirmPinError->setText(QString());
        label_DateError->setText(QString());
        dateEdit->setDisplayFormat(QCoreApplication::translate("USERADDING", "d/M/yyyy", nullptr));
        label_PinError->setText(QString());
        pushButton_SignUP->setText(QCoreApplication::translate("USERADDING", "Sign up", nullptr));
        label_EmptyDataError->setText(QString());
        pushButton_SignUP_2->setText(QCoreApplication::translate("USERADDING", "Cancel", nullptr));
        label_9->setText(QCoreApplication::translate("USERADDING", "ADD NEW USER", nullptr));
    } // retranslateUi

};

namespace Ui {
    class USERADDING: public Ui_USERADDING {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_USERADDING_H
